...
aggregated_snp_model = api.inherit('Aggregated SNP', aggregated_snp_model_short, {
    'chromosome': fields.String(enumerate=chromosomes, attribute='snp.chromosome'),
    'position': fields.Integer(attribute='snp.position'),
    'ref': fields.String(enumerate=nucleotides, attribute='snp.ref'),
    'alt': fields.String(enumerate=nucleotides, attribute='snp.alt'),
})

aggregated_snp_model_short = api.model('Aggregated SNP (no genome info) ', {
    'p_value_ref': fields.Float,
    'p_value_alt': fields.Float,
    'is_asb': fields.Boolean,
    'es_ref': fields.Float,
...
tf_snp_model = api.inherit('Transcription Factor SNP', aggregated_snp_model, {
    'tf_snp_id': fields.Integer(readonly=True),
    'transcription_factor': fields.Nested(transcription_factor_model),
})

cl_snp_model = api.inherit('Cell line SNP', aggregated_snp_model, {
