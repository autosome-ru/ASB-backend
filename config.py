...
class Config(object):
    SQLALCHEMY_BINDS = {
        ...
        'candidates_mabel': 'mysql://adastra:pass=ADASTRA880@localhost:3306/adastra_candidates_billcipher?charset=utf8',
        'mabel': 'mysql://adastra:pass=ADASTRA880@localhost:3306/adastra_billcipher_fixed_motifs?charset=utf8',
